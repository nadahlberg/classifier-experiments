...
[`docker/django/Dockerfile`](https://github.com/nadahlberg/starter/blob/868de346604677e8e70a55e0be811197c2794c35/docker/django/Dockerfile) starts from `python:3.13-slim`
...
dev compose runs. [`install-tailwind.sh`](https://github.com/nadahlberg/starter/blob/868de346604677e8e70a55e0be811197c2794c35/docker/django/install-tailwind.sh) downloads the
...
[`.dockerignore`](https://github.com/nadahlberg/starter/blob/868de346604677e8e70a55e0be811197c2794c35/.dockerignore) keeps `local/`, `references/`, `media/`,
`infra/` and the git history out of the build context, so scratch work never
invalidates a layer.

## The entrypoint

The image's default command, [`entrypoint.sh`](https://github.com/nadahlberg/starter/blob/868de346604677e8e70a55e0be811197c2794c35/docker/django/entrypoint.sh), runs
