...
Every push to `main` and every pull request runs [`ci.yml`](https://github.com/nadahlberg/starter/blob/868de346604677e8e70a55e0be811197c2794c35/.github/workflows/ci.yml):
