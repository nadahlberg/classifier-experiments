...
[`docker-compose.yml`](sym:35b8c161ff77) runs off the same image, built from
...
[`DATABASES`](sym:960aa9d48d8a) reads the `POSTGRES_*` variables,
[`REDIS_URL`](sym:8f6b6fb42801) points at redis, and
[`ELASTICSEARCH_URL`](sym:b4dd1fa10bec) at elasticsearch. Compose publishes
...
`pyproject.toml` installs — [`manage.main`](sym:47c383953066,bace54cf3d69)
